      ...
      <section id="contact" className="hairline-t bg-surface/30">
        ...
        <footer className="hairline-t">
          <div className="mx-auto max-w-7xl px-6 py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-ink-dim">
            ...
            <div className="flex flex-row gap-4 text-base text-ink-dim">
              {/* <a href="https://github.com" target="_blank" aria-label="GitHub Profile">
                <svg xmlns="http://w3.org" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-github">
              ...
              <a href="https://linkedin.com" target="_blank" aria-label="LinkedIn Profile">
                <svg xmlns="http://w3.org" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-linkedin">
                  <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                  <rect x="2" y="9" width="4" height="12"></rect>
                  <circle cx="4" cy="4" r="2"></circle>
                </svg>
              </a> */}
              <a href="https://github.com/manikandan-uthaman/" target="_blank"><FontAwesomeIcon icon={faGithub} /></a>
              <a href="https://www.linkedin.com/in/manikandan-uthaman/" target="_blank"><FontAwesomeIcon icon={faLinkedinIn} /></a>
            </div>
